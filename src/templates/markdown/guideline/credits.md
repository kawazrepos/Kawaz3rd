...
- Kawazのロゴや名称を統一し、Kawazブランドを維持するため
...
本ガイドラインでは、以下の条件に当てはまっている作品を「Kawazのプロジェクト」としています。
...
上記に当てはまらないプロジェクトを「Kawaz以外のプロジェクト」と扱い、クレジットの表記を行う必要はありません。

例えば、以下のようなプロジェクトが該当します。

- Kawazメンバーが一人で作品を作成し、公開する
- 外部のサークルが主導しているプロジェクトへ製作メンバーとして参加している

この場合、必ずしもクレジットを表示する必要がありませんが、スペシャルサンクスなど、
クレジットを記載したい場合は、下記ガイドラインに従って表記してください。

また、掲載状況を把握したいため、Kawazのロゴやクレジットを表記したい場合は、運営メンバーまでお問い合わせください
...
- Kawazロゴの表記
- URLの記載[http://www.kawaz.org](http://www.kawaz.org)、か、URLのQRコードを表記
...
- コントラストや色の変更はNG
- ロゴに加筆したり、トリミングを行う行為はNG
- サイズの変更はアスペクト比が変わらない範囲で可能である


その他、ロゴ素材が作品と合わない場合など、作品にあわせてロゴを改編したい場合は、運営メンバーへご相談ください。
例えば、以下のような加工を行いたい場合、運営メンバーへ確認を取ってください。

- 黒基調のデザインのため、背景を黒系に変更し、ロゴを白くしたい
