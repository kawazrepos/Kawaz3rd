...
urlpatterns = patterns('',
    ...
    url(r'^(?P<object_id>\d+)/$', EventDetailView.as_view(), name='events_event_detail'),
    url(r'^create/$', EventCreateView.as_view(), name='events_event_create'),
    url(r'^(?P<object_id>\d+)/update/$', EventUpdateView.as_view(), name='events_event_update'),
    url(r'^(?P<object_id>\d+)/delete/$', EventDeleteView.as_view(), name='events_event_delete'),
    url(r'^(?P<object_id>\d+)/join/$', EventJoinView.as_view(), name='events_event_join'),
    url(r'^(?P<object_id>\d+)/quit/$', EventQuitView.as_view(), name='events_event_quit'),
    url(r'^(?P<object_id>\d+)/quit/(?P<user>[^/]+)/$', EventQuitView.as_view(), name='events_event_quit'),
